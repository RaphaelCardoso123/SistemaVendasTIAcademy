    ...
    <div class="form" style="padding: 1%;">
        ...
        <div class="col-4">
            <div>
                ...
                <input type="text" disabled v-model="vendedor.id" class="form-control" placeholder="Nome">
            </div>
            <div>
            ...
            <button class="btn btn-success" @click="atualizarVendedor" style="margin-top: 2%;">Atualizar</button>
        </div>
    </div>
</template>
<script>
